...
```sh
npm install --save enzyme enzyme-adapter-react-16 Multi-container-with-kubernetes-renderer
```

Alternatively you may use `yarn`:

```sh
yarn add enzyme enzyme-adapter-react-16 Multi-container-with-kubernetes-renderer
```
